...
class MagicMirrorScreen extends StatefulWidget {
  @override
  _MagicMirrorScreenState createState() => _MagicMirrorScreenState();
}
...
class _MagicMirrorState extends State<MagicMirror> with SingleTickerProviderStateMixin {
  ...
  void didUpdateWidget(MagicMirror oldWidget) {
    if(oldWidget.imagePath != widget.imagePath){
      ...
      print('switching from ${widget.imagePath} & ${widget.nextImagePath}');
      print('to ${oldWidget.imagePath} & ${oldWidget.nextImagePath}');
    }
