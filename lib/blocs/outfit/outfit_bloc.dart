...
class OutfitBloc{
  ...
  final _exploredOutfitsController = BehaviorSubject<List<Outfit>>.seeded([]);
  Stream<List<Outfit>> get exploredOutfits => _exploredOutfitsController.stream; 
  final _lookbookOutfitsController = BehaviorSubject<List<Outfit>>.seeded([]);
  Stream<List<Outfit>> get lookbookOutfits => _lookbookOutfitsController.stream; 
  final _myOutfitsController = BehaviorSubject<List<Outfit>>.seeded([]);
  Stream<List<Outfit>> get myOutfits => _myOutfitsController.stream; 
  final _selectedOutfitsController = BehaviorSubject<List<Outfit>>.seeded([]);
  Stream<List<Outfit>> get selectedOutfits => _selectedOutfitsController.stream; 
  final _feedOutfitsController = BehaviorSubject<List<Outfit>>.seeded([]);
  ...
  final _selectedOutfitController = BehaviorSubject<Outfit>.seeded(null);
  ...
  final _lookbooksController = BehaviorSubject<List<Lookbook>>.seeded([]);
  ...
  Stream<void> get showAd => _showAdController.stream;

  final _isBackgroundLoadingController = PublishSubject<bool>();
  Stream<bool> get isBackgroundLoading => _isBackgroundLoadingController.stream;

  final _noOutfitFoundController = PublishSubject<bool>();
  Stream<bool> get noOutfitFound => _noOutfitFoundController.stream;

  final _loadingController = BehaviorSubject<bool>.seeded(false);
  BehaviorSubject<bool> get isLoading => _loadingController.stream;
  final _loadingItemsController = BehaviorSubject<bool>.seeded(false);
  BehaviorSubject<bool> get isLoadingItems => _loadingItemsController;
  final _isLoadingExploreController = BehaviorSubject<bool>.seeded(false);
  BehaviorSubject<bool> get isLoadingExplore => _isLoadingExploreController;
  final _isLoadingMyOutfitsController = BehaviorSubject<bool>.seeded(false);
  BehaviorSubject<bool> get isLoadingMyOutfits => _isLoadingMyOutfitsController;
  final _isLoadingFeedController = BehaviorSubject<bool>.seeded(false);
  BehaviorSubject<bool> get isLoadingFeed => _isLoadingFeedController;
  final _isLoadingSelectedController = BehaviorSubject<bool>.seeded(false);
