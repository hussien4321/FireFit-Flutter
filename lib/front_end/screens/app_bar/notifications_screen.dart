...
class _NotificationsScreenState extends State<NotificationsScreen> {
      ...
      body: Container(
        child: StreamBuilder<bool>(
          ...
          builder: (ctx, isLoadingSnap) =>
              StreamBuilder<List<OutfitNotification>>(
            ...
            builder: (ctx, snap) {
              ...
              return PullToRefreshOverlay(
                ...
                child: ListView(
                    ...
                    children: _buildNotifications(notifications)
                      ..add(_buildEndTag(
                          isLoadingSnap.data, notifications.isEmpty))),
              );
            },
          ),
        ),
    ...
    return showDialog(
            ...
            builder: (secondContext) {
              ...
              return YesNoDialog(
                title: 'Mark as seen',
                description:
                    'Are you sure you want to mark all notifications as seen?',
                yesText: 'Yes',
                noText: 'Cancel',
                onYes: () {
  ...
  Widget _noNotificationsTag(bool isEmpty) {
    return Text(
      ...
      style:
          Theme.of(context).textTheme.subtitle2.copyWith(color: Colors.black54),
