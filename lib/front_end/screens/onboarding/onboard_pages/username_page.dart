...
class _UsernamePageState extends State<UsernamePage> with SnackbarMessages {
        ...
        body: StreamBuilder<bool>(
            ...
            builder: (context, isUsernameTakenSnapshot) {
              if (isUsernameTakenSnapshot.hasData) {
                widget.onboardUser.isUsernameTaken =
                    isUsernameTakenSnapshot.data;
                      ...
                      children: <Widget>[
                        Expanded(
                          child: CustomTextField(
                            ...
                            onSubmitted: (t) => FocusScope.of(context)
                          ...
                          child: CustomTextField(
                            ...
                            textColor:
                                widget.onboardUser.isUsernameTaken == null ||
                                        !widget.onboardUser.isUsernameLongEnough
                                    ? Colors.black
                                    : (widget.onboardUser.isUsernameTaken
                                        ? Colors.red
                                        : Colors.blue),
                        ...
                        children: <Widget>[
                          Text(
                            ...
                            style: Theme.of(context).textTheme.caption.apply(
                                color: widget.onboardUser.isUsernameTaken ==
                                            null ||
                                        !widget.onboardUser.isUsernameLongEnough
  ...
  _parseNewUsername(String newUsername) {
    ...
    widget.onboardUser.isUsernameLongEnough =
        formattedUsername.length >= MINIMUM_USERNAME_LENGTH;
