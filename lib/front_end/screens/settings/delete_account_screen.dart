        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _deletionSummary(),
              _deleteButton(),
              Text('Good luck on your fashion journey!👋'),
            ],
          ),
        ),
      ),
  ...
  Widget _deletionSummary() {
    return RichText(
      text: TextSpan(style: Theme.of(context).textTheme.caption, children: [
        ...
        TextSpan(text: "    All the outfits you have uploaded\n\n"),
        TextSpan(text: "    All the lookbooks you have created\n\n"),
        TextSpan(
          text:
              "Please note however, this does NOT cancel any active subscription you may have, you can do so from the app store.",
