...
class _FeedbackScreenState extends State<FeedbackScreen> with LoadingAndErrorDialogs {
  ...
  final String _emailLink = 'mailto:support@firefitapp.com?subject=User%20Feedback&body=Hi%20there,%0D%0A%0D%0AI wanted to give some feedback for FireFit:%0D%0A%0D%0A';
          ...
          items: FeedbackType.values.map((type) {
            return DropdownMenuItem(
              child: Text(
                ...
                style: TextStyle(
                  inherit: true,
                  color: type==_feedbackRequest.type ? Colors.blue: Colors.grey
                ),
              ),
              value: type,
            );
  ...
  Widget _receiveResponseCheck(){
    return Row(
      ...
      children: <Widget>[
        Text(
          'Receive an email back from our team?'
        ),
        Checkbox(
          value: _feedbackRequest.isRequestingResponse,
          onChanged: (newVal) => setState(() => _feedbackRequest.isRequestingResponse = newVal),
      ...
      child: RichText(
        ...
        text: TextSpan(
          ...
          children: [
            ...
            TextSpan(
              text: 'support@firefitapp.com',
              style: TextStyle(
                inherit: true,
                color: Colors.blue,
                decoration: TextDecoration.underline
              ),
            recognizer: TapGestureRecognizer()..onTap = _createEmailTemplate,
            ),
          ]
        ),
      )
