...
class AnalyticsEvents {
  ...
  setUserId(String id) => _analytics.setUserId(id: id);
  ...
  profileViewed(User user) => _analytics.logEvent(
        name: 'profile_viewed',
        parameters: {'itemId': user.userId, 'itemName': user.username},
      );
  ...
  //Exception
  catchException({String code, String message, dynamic details}) =>
      _analytics.logEvent(
          name: "app_exception",
          parameters: {"code": code, "message": message, "details": details});
}
