...
class _NotificationTabState extends State<NotificationTab> {
      ...
      child: InkWell(
        ...
        child: Container(
            ...
            child: Row(
              children: <Widget>[
                GestureDetector(
                  onTap: () => CustomNavigator.goToProfileScreen(
                    context,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Text(
                              DateFormatter.dateToRecentFormat(
                            ...
                            child: Container(
                              ...
                              child: RichText(
                                text: TextSpan(children: [
                                  ...
                                  TextSpan(
                                      text:
                                          ' ${widget.notification.getNotificationDescription} ',
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyText1),
                                  TextSpan(
                                      text: isCommentNotification
                                          ? refComment?.text
                                          : refOutfit?.title,
                                      style: Theme.of(context)
                                          .textTheme
  ...
  _openNotification() {
    ...
    if (widget.notification.type == NotificationType.OUTFIT_RATING ||
        widget.notification.type == NotificationType.NEW_OUTFIT) {
      CustomNavigator.goToOutfitDetailsScreen(context,
          outfitId: refOutfit.outfitId, loadOutfit: true);
    }
  ...
  bool get isCommentNotification =>
      widget.notification.type == NotificationType.NEW_COMMENT ||
      widget.notification.type == NotificationType.COMMENT_LIKE ||
      widget.notification.type == NotificationType.COMMENT_REPLY ||
      widget.notification.type == NotificationType.REPLY_THREAD;
}
