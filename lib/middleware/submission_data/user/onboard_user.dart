class OnboardUser {
  ...
  bool isComplete() {
    ...
    && countryCode.length > 0 && username.length > 0 && name.length > 0 && profilePicUrl.length > 0  && email.length > 0  && isUsernameTaken == false && isUsernameLongEnough && hasConfirmedAge;
  }
